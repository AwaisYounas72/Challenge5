...
const Description = () => {
  return (
    <div className="md:mt-20  mt-5 flex flex-col gap-7 text-justify">

        <div className="md:text-3xl md:font-medium font-normal text-xl    w-full     md:text-start text-center  ">
