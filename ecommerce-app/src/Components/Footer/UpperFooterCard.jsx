...
const UpperFooterCard = () => {
  return (
    <div className="bg-black text-white  rounded-md flex flex-col items-center py-8  w-full">
      <div className="w-[80%] flex flex-col items-center md:items-start text-center md:text-left justify-center md:justify-start ">
        <div className="my-8 space-y-7">
          ...
          <div>
            <button className="bg-white text-black  rounded-full py-1 px-2">Say hej</button>
            {/* <Button text="Say Hej" className="bg-white text-black text-lg font-bold" position="md:justify-start justify-center" /> */}
          </div>
        </div>
